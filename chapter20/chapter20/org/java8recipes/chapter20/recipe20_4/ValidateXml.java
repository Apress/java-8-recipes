package org.java8recipes.chapter20.recipe20_4;
...
public class ValidateXml {
    ...
    public static void main(String[] args) {
        if (args.length != 2) {
            System.out.println("Usage: java org.java8recipes.chapter20.recipe20_4.ValidateXml <xmlFile> <validationFile>");
            System.exit(1);
        }
